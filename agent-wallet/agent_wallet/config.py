...
class Settings(BaseSettings):
    ...
    jupiter_api_key: str = ""
    mayan_price_api_base_url: str = "https://price-api.mayan.finance/v3"
    mayan_explorer_api_base_url: str = "https://explorer-api.mayan.finance/v3"
    mayan_api_referer: str = "https://docs.mayan.finance"
    mayan_api_key: str = ""
    mayan_forwarder_contract: str = "0x337685fdaB40D39bd02028545a4FfA7D287cC3E2"
    mayan_solana_program_id: str = "FC4eXxkyrMPTjiYUpp4EAnkmwMbQyZ6NDCh1kfLn6vsf"
    mayan_sdk_version: str = "13_3_0"
